# -*- coding: utf-8 -*-
"""Module for interacting with AI models via g4f"""

__author__ = "mlwr.e"  # Укажите ваше имя/ник
__version__ = "1.0.0"
...
class G4fAskMod(Module):
    """Provides commands to interact with various AI models using the g4f library.

    Commands:
        .ai: Set the default AI model.
        .ask: Ask a question to the configured AI model.
    """
